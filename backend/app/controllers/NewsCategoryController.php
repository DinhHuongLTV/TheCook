...
class NewsCategoryController extends Controller
{
    public function index($category_name = "")
    {
        ...
        $this->__data['page_title'] = "Danh sách hạng mục tin tức";
        $this->__data['content'] = "newscategories/index";
        ...
        if (isset($_POST['submit'])) {
            ...
            if ($has_error == 0) {
                if ($avatar['error'] == 0) {
                    ...
                    $filename = time() . "-newsCategory-" . $avatar['name'];
                ...
                header("Location: index.php?controller=newsCategory&action=index");
                exit();
            }
        }
        $this->__data['page_title'] = "Thêm hạng mục mới";
        $this->__data['content'] = "newscategories/create";
        $this->render('layouts/main', $this->__data);
    }
    ...
    public function update()
    {
        ...
        $this->__data['content'] = "newscategories/update";
        $this->render('layouts/main', $this->__data);
    }
    ...
    public function detail()
    {
        ...
        $this->__data['content'] = "newscategories/detail";
        $this->render('layouts/main', $this->__data);
    }
}