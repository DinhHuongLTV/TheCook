...
<a href="index.php?controller=chefCategory&action=create" class="btn btn-success">
    ...
    <?php if (!empty($data)): ?>
        <?php foreach ($data as $category): ?>
            <tr>
                ...
                <td>
                    <?php
                    $url_detail = "index.php?controller=chefCategory&action=detail&id=" . $category['id'];
                    $url_update = "index.php?controller=chefCategory&action=update&id=" . $category['id'];
                    $url_delete = "index.php?controller=chefCategory&action=delete&id=" . $category['id'];
                    ?>
