<form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <img src="assets/uploads/<?php echo $data['avatar']?>" alt="Ảnh đại diện" style="height: 50px; width: 50px; border-radius: 50px">
        <?php endif;?>
    ...
    <div class="form-group">
        ...
        <select name="status" id="">
            <?php
                $select_disabled = "";
                $select_active = "";
                $data['status'] == 1 ? $select_active = "selected" : $select_disabled = "selected";
            ?>
            <option value="1" <?php echo $select_active?> >Active</option>
            <option value="0" <?php echo $select_disabled?> >Disabled</option>
        </select>
    </div>
    <div class="form-group">
