...
class ChefController extends Controller
{
    ...
    public function detail() {
        ...
        $this->__data['content'] = "chef/detail_user";
        if (isset($_SESSION['user']) && $_SESSION['user']['user_category_id'] == 2) {
    ...
    public function index() {
        ...
        $this->__data['data']['categories'] = $category_model->getAll();
        $this->__data['data']['chefs'] = $chef_model->getAll();
        $this->__data['content'] = "chef/category_carousel";
        $this->__data['page_title'] = "Đầu bếp";
        $this->__data['header'] = "blocks/header_logined";
        $this->__data['footer'] = "blocks/footer_main";
        $this->render("layouts/main", $this->__data);
    }
