...
class ChefCategoryModel extends Model
{
    ...
    public function getAll($params = [])
    {
        ...
        $sql_select_all = "SELECT * FROM chef_categories $sql_search";
    ...
    public function getById($id) {
        $sql_select = "SELECT * FROM chef_categories WHERE id = :id";
    ...
    public function create() {
        $sql_create = "INSERT INTO chef_categories (name, description, status, avatar) VALUES (:name, :description, :status, :avatar)";
    ...
    public function update($id) {
        $sql_update = "UPDATE chef_categories SET name = :name, description = :description, status = :status, avatar = :avatar WHERE id = :id";
    ...
    public function getByName($name) {
        $sql_select = "SELECT * FROM chef_categories WHERE name = :name";
        $obj_select = $this->__connection->prepare($sql_select);
        $data = [
            ':name' => $name
        ];
    ...
    public function delete($id) {
        $sql_delete = "DELETE FROM chef_categories WHERE id = :id";
    ...
    {
        $sql_count = "SELECT COUNT(id) FROM chef_categories WHERE TRUE";
